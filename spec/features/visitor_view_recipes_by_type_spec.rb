...
feature 'Visitor view recipes by type' do
  ...
  pequenos, misture com o restante dos ingredientes', user: user)
  ...
  scenario 'and view only recipes from same type' do
    ...
    dessert_recipe = Recipe.create(title: 'Bolo de cenoura',
                                   ...
                                   cook_time: 60,
                                   ingredients: 'Farinha, açucar, cenoura',
                                   method: 'Cozinhe a cenoura, corte em, \
  pedaços pequenos, misture com o restante dos ingredientes', user: user)
...
ficar al dent; Misture os ovos e o bacon a massa ainda quente;', user: user)
    # simula a acao do usuario
    visit root_path
